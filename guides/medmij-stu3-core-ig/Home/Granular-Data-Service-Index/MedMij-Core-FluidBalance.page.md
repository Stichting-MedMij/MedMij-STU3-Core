...
| | |
| --- | --- |
| **FHIR profile(s)**             | [zib-FluidBalance](https://simplifier.net/packages/nictiz.fhir.nl.stu3.zib2017/2.3.2/files/3019038) |
...
`GET [base]/Observation?code=http://snomed.info/sct|364396009`