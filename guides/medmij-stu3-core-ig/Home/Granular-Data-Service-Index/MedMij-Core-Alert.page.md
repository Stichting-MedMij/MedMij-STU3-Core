...
| --- | --- |
| **Id**                          | TBD |
| **Data service name (English)** | MedMij Core - Alert |
| **Data service name (Dutch)**   | MedMij Core - Alert |
...
| | |
| --- | --- |
| **FHIR profile(s)**             | [zib-Alert](https://simplifier.net/packages/nictiz.fhir.nl.stu3.zib2017/2.3.2/files/3019001) |
