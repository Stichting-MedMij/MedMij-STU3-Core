...
| | |
| --- | --- |
| **FHIR profile(s)** | {{link: http://nictiz.nl/fhir/StructureDefinition/zib-NutritionAdvice, title: http://nictiz.nl/fhir/StructureDefinition/zib-NutritionAdvice}} |
...
| **Must Support** | <ul> <li> `.identifier` <li> `.patient` <li> `.dateTime` <li> `.orderer` (including the {{link: http://nictiz.nl/fhir/StructureDefinition/practitionerrole-reference, title: practitionerrole-reference extension}}) |
