...
| --- | --- |
| **Id**                          | TBD |
| **Data service name (English)** | MedMij Core - Payer |
| **Data service name (Dutch)**   | MedMij Core - Betaler |
...
| | |
| --- | --- |
| **FHIR profile(s)**             | [zib-Payer](https://simplifier.net/packages/nictiz.fhir.nl.stu3.zib2017/2.3.2/files/3019098) |
