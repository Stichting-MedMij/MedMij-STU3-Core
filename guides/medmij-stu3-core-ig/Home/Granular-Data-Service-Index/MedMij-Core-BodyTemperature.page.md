...
| **CapabilityStatement(s)** | {{pagelink: CapabilityStatementsIndex, text: Body Temperature (Retrieve), anchor: BodyTemperatureRetrieve}} <br/> {{pagelink: CapabilityStatementsIndex, text: Body Temperature (Serve), anchor: BodyTemperatureServe}} |
