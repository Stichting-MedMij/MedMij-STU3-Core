...
| **System role(s)** | MMC-BTR-zib2017/STU3-1.0.0-beta.1-FHIR (PHR) <br/> MMC-BTB-zib2017/STU3-1.0.0-beta.1-FHIR (XIS) |
...
| **CapabilityStatement(s)** | [MedMij Core BodyTemperature Retrieve](http://medmij.nl/fhir/CapabilityStatement/medmij-core-BodyTemperature-Retrieve) <br/> [MedMij Core BodyTemperature Serve](http://medmij.nl/fhir/CapabilityStatement/medmij-core-BodyTemperature-Serve) |
