...
- **Technical specification**
    ...
    - **FHIR version** - the version of FHIR in which the profiles corresponding to the CIM have been created, which is always _STU3_ in this IG.
